...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleFileUploadLicense: function handleFileUploadLicense() {
      var file = this.$refs.file_license.files[0]; // Reset previous error message

      this.drivingLicencevalidationerror = null; // Check if a file was selected
    ...
    handleFileUploadCard: function handleFileUploadCard() {
      var file = this.$refs.file_card.files[0]; // Reset previous error message

      this.nationalIdentityCardvalidationerror = null; // Check if a file was selected
    ...
    saveRecord: function saveRecord() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, formData, {
        ...
        if (data.status === 1) {
          ...
          }, 2000); //this.$eventBus.$emit('deliveryBoysSaved', data.message);
        } else {
