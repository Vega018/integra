...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    dropFile: function dropFile(event) {
      ...
      this.handleLogoUpload(); // Clean up
    ...
    handleLogoUpload: function handleLogoUpload() {
      var file = this.$refs.logo.files[0]; // Reset previous error message

      this.error = null; // Check if a file was selected
    ...
    handleFssaiLicImgUpload: function handleFssaiLicImgUpload() {
      var file = this.$refs.fssai_lic_img.files[0]; // Reset previous error message
                    ...
                    _c("div", { staticClass: "row" }, [
                      ...
                      _c("div", { staticClass: "col-md-6" }, [
                        ...
                        _c("input", {
                          ...
                          on: { change: _vm.handleFssaiLicImgUpload },
                        }),
                        _vm._v(" "),
                        _c(
                          "div",
              ...
              _c("div", { staticClass: "card-body" }, [
                ...
                _c("div", { staticClass: "row" }, [
                  _c("div", { staticClass: "form-group col-md-4" }, [
                    ...
                    _vm._v(" "),
                    _vm.store_settings.is_category_section_in_homepage == 1
                      ? _c("div", { staticClass: "form-floating mb-3" }, [
                          _c("input", {
                            directives: [
                              {
                          ...
                          _vm._v(" "),
                          _c("label", { attrs: { for: "" } }, [
                            _vm._v("Count Category Display in Homepage"),
                          ]),
                          _vm._v(" "),
                          _vm.validationCategoryError
                            ? _c("span", { staticClass: "error" }, [
                                _vm._v(_vm._s(_vm.validationCategoryError)),
                              ])
                            : _vm._e(),
                        ])
                      : _vm._e(),
                  ...
                  _c("div", { staticClass: "form-group col-md-4" }, [
                    ...
                    _vm._v(" "),
                    _vm.store_settings.is_brand_section_in_homepage == 1
                      ? _c("div", { staticClass: "form-floating mb-3" }, [
                          _c("input", {
                            directives: [
                              {
                          ...
                          _vm._v(" "),
                          _c("label", { attrs: { for: "" } }, [
                            _vm._v("Count Brand Display in Homepage"),
                          ]),
                          _vm._v(" "),
                          _vm.validationBrandError
                            ? _c("span", { staticClass: "error" }, [
                                _vm._v(_vm._s(_vm.validationBrandError)),
                              ])
                            : _vm._e(),
                        ])
                      : _vm._e(),
...
var staticRenderFns = [
  ...
  function () {
    ...
    return _c("label", { attrs: { for: "" } }, [
      _vm._v("Display Category Section in Home Page? "),
      _c("span", { staticClass: "text text-primary font-size-13" }, [
        _vm._v("( Enable/Disable\n                                        )"),
      ]),
    ])
  ...
  function () {
    ...
    var _c = _vm._self._c || _h
    return _c("label", { attrs: { for: "" } }, [
      _vm._v("Display Brand Section in Home Page? "),
      _c("span", { staticClass: "text text-primary font-size-13" }, [
        _vm._v("( Enable/Disable\n                                        )"),
      ]),
    ])
