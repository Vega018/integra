                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" required name="support_number"
                                           id="support_number" v-model="store_settings.support_number" inputmode="numeric"
                                           placeholder="Customer support mobile number - used in whole system +91 9876543210" @input="validateMobileNumber"/>
...
<!--                                <div class="form-group col-md-4" v-if="store_settings.is_version_system_on == 1">
                                ...
                                <div class="form-group col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="logo">Fssai Lic Image</label>
                                            ...
                                            <span v-if="Fssaierror" class="error">{{ Fssaierror }}</span>
                                                ...
                                                <template v-if="fssai_lic_img_name && fssai_lic_img_name !== ''">
                                                    <label>Selected file name:- {{ fssai_lic_img_name }}</label>
                                                </template>
                                                <template v-else>
                                                    <label><i class="fa fa-cloud-upload fa-2x"></i></label>
                                                    <label>{{ __('drop_files_here_or_click_to_upload') }}</label>
...
<!--                    <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">FrontEnd Home Setting</h4>
                        </div>
                        <div class="card-body">
                            <span class=" text text-primary font-size-13">In this mode you can set your app in Maintenance and that Appilication will not work till not disabled from here</span>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="">Display Category Section in Home Page? <span
                                        class="text text-primary font-size-13">( Enable/Disable
                                        )</span></label><br>
                                    <div class="form-check form-switch">
                                    ...
                                    <div class="form-floating mb-3" v-if="store_settings.is_category_section_in_homepage == 1" >
                                        ...
                                        <label for="">Count Category Display in Homepage</label>
                                        <span v-if="validationCategoryError" class="error">{{ validationCategoryError }}</span>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="">Display Brand Section in Home Page? <span
                                        class="text text-primary font-size-13">( Enable/Disable
                                        )</span></label><br>
                                    <div class="form-check form-switch">
                                    ...
                                    <div class="form-floating mb-3" v-if="store_settings.is_brand_section_in_homepage == 1" >
                                        ...
                                        <label for="">Count Brand Display in Homepage</label>
